      ...
      <div style={{ padding: 24 }}>
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={styles.row}>
            <TextField size='small' name="sharelink" onChange={handlesharelink} fullWidth id="outlined-basic" label={age?.name ? `${age.name} will be shared` : 'Select project to share'} variant="outlined" />
          ...
          <div style={{ display: "flex", flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
            <TextField size='small' fullWidth id="outlined-basic"  multiline label="Add single email you want to send to" variant="outlined" value={userEmail} onChange={(e) => setUserEmail(e.target.value)} />
